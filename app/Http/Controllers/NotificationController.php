...
class NotificationController extends Controller
{
    ...
    {
        $notifications = Notification::where('structure_id', Auth::user()->structure_id)->where('destinateur', 'structure')->get()->sortByDesc('id');
        return view('dashboards.notification.index',compact('notifications'));
    }
    
    public function list()
    {
        $notifications = Notification::where('user_id', Auth::user()->id)->where('destinateur', 'usager')->get()->sortByDesc('id');
